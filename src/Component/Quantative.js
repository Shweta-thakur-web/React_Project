        ...
        return (
            <div>
                <div class="container mt-4">
                    <div class="row">
                        <div class="col-sm-6 col-md-6 col-lg-6">
                            <br />
                            <img src="Images/Quantitative.jpeg" style={{width:'100%', height:'350px', marginTop:'10%'}}/>
                        </div>
                        <div class="col-sm-6 col-md-6 col-lg-6" style={{marginTop:'5%'}}>
                            <center class="wow fadeInUp" style={{marginTop:'4.7%'}}>
                                <h3 style={{fontFamily:"'Source Sans Pro', sans-serif", backgroundColor:'#3a56a1', color:'#fff', padding:'10px 20px', borderRadius:'5px',border:'2px solid #000' }}>QUANTITATIVE RESEARCH</h3>
                                <p style={{textAlign:'justify', fontSize:'16px', lineHeight:'24px', color:'#000'}}>
                                    <span class="block">
                ...
                <div>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-12 col-lg-12">
                                    <center class="wow fadeInUp">
                                        <h3 style={{fontFamily:"'Source Sans Pro',sans-serif",color:'#fff', }}>HOW DOES QUANTITATIVE RESEARCH WORK?</h3>
                                        <p style={{textAlign:'justify', fontSize:'16px', lineHeight:'24px', color:'#fff'}}>
                    ...
                    <br />
                    <div class="container" style={{backgroundColor:'#f4f4f4'}}>
                        <div class="row">
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                <center class="wow fadeInUp">
                                    <h3 style={{fontFamily:"'Source Sans Pro',sans-serif",fontWeight:'bolder'}} class="text-primary">TYPES OF QUANTITATIVE DESIGN</h3>
                                </center>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6 col-md-6 col-lg-6">
                                <center class="wow fadeInUp">
                                    <h3 style={{fontFamily:"'Source Sans Pro', sans-serif", backgroundColor:'#3a56a1', color:'#fff', padding:'10px 20px', borderRadius:'5px',border:'2px solid #000'}}>Descriptive research</h3>
                                    <p style={{textAlign:'justify', fontSize:'16px', lineHeight:'24px', color:'#000'}}>
                                        <span class="block">
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-6">
                                <center class="wow fadeInUp">
                                    <h3 style={{fontFamily:"'Source Sans Pro', sans-serif", backgroundColor:'#3a56a1', color:'#fff', padding:'10px 20px', borderRadius:'5px',border:'2px solid #000' }}>Correlational research</h3>
                                    <p style={{textAlign:'justify', fontSize:'16px', lineHeight:'24px', color:'#000'}}>
                                        <span class="block">
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-md-6 col-lg-6">
                                <center class="wow fadeInUp">
                                    <h3 style={{fontFamily:"'Source Sans Pro', sans-serif", backgroundColor:'#3a56a1', color:'#fff', padding:'10px 20px', borderRadius:'5px',border:'2px solid #000' }}>Quasi-experimental research</h3>
                                    <p style={{textAlign:'justify', fontSize:'16px', lineHeight:'24px', color:'#000'}}>
                                        <span class="block">
                                            As the name suggests, this method is used to find relations between two or more variables. Correlational research is designed to interpret relations between and among several facts. This will determine the trends and patterns in data and there is no manipulation of information done here. They are identified and studied in their absolute natural setting.</span>
                                        <br /><br />
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-6">
                                <center class="wow fadeInUp">
                                    <h3 style={{fontFamily:"'Source Sans Pro', sans-serif", backgroundColor:'#3a56a1', color:'#fff', padding:'10px 20px', borderRadius:'5px',border:'2px solid #000' }}>Experimental research</h3>
                                    <p style={{textAlign:'justify', fontSize:'16px', lineHeight:'24px', color:'#000'}}>
                                        <span class="block">
                    ...
                    <div style={{backgroundColor:'#3a56a1',padding:' 38px 20px'}}>
                        <div class="container">
                            <div class="row">
                                <div class="col-sm-12 col-md-12 col-lg-12">
                                    <center class="wow fadeInUp">
                                        <h3 style={{fontFamily:"'Source Sans Pro',sans-serif",color:'#fff', }}>WHY CHOOSE ONE WAY SOLUTIONS?</h3>
                                        <p style={{textAlign:'justify', fontSize:'16px', lineHeight:'24px', color:'#fff'}}>
