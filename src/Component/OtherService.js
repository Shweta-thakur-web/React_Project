 ...
 <div class="container mt-5">
        <div class="row">
            <div class="col-sm-6 col-md-6 col-lg-6">
                <br/>
                <img src="Images/OtherService.jpeg" style={{width:'100%', height:'355px', marginTop:'10%'}}/>
            </div>
            <div class="col-sm-6 col-md-6 col-lg-6" style={{marginTop:'5%'}}>
                <center class="wow fadeInUp" style={{marginTop:'3.2%'}}>
                    <h3 style={{fontFamily:"'Source Sans Pro', sans-serif", backgroundColor:'#3a56a1', color:'#fff', padding:'10px 20px', borderRadius:'5px',border:'2px solid #000' }}>OTHER SERVICES</h3>
                    ...
                    <p style={{fontSize:'26px', lineHeight:'24px', color:'#000'}}>
                        <b>
    ...
    <div>
        ...
        <div class="container" style={{backgroundColor:'#f4f4f4'}}>
            <div class="row">
                <div class="col-sm-6 col-md-6 col-lg-6">
                    <center class="wow fadeInUp">
                        <h3 style={{fontFamily:"'Source Sans Pro', sans-serif", backgroundColor:'#3a56a1', color:'#fff', padding:'10px 20px', borderRadius:'5px',border:'2px solid #000'}}>Solutions For Teams</h3>
                    </center>
                        <p style={{textAlign:'justify', fontSize:'16px', lineHeight:'24px', color:'#000'}}>
                            <div id="selection">
                                <ul>
                ...
                <div class="col-sm-6 col-md-6 col-lg-6">
                    <center class="wow fadeInUp">
                        <h3 style={{fontFamily:"'Source Sans Pro', sans-serif", backgroundColor:'#3a56a1', color:'#fff', padding:'10px 20px', borderRadius:'5px',border:'2px solid #000'}}>People Powered Data For Business</h3>
                    </center>
                        <p style={{textAlign:'justify', fontSize:'16px', lineHeight:'24px', color:'#000'}}>
                            <div id="selection">
                                <ul>
            ...
            <div class="row">
                <div class="col-sm-6 col-md-6 col-lg-6">
                    <center class="wow fadeInUp">
                        <h3 style={{fontFamily:"'Source Sans Pro', sans-serif", backgroundColor:'#3a56a1', color:'#fff', padding:'10px 20px', borderRadius:'5px',border:'2px solid #000' }}>	Surveys Types</h3>
                    </center>
                        <p style={{textAlign:'justify', fontSize:'16px', lineHeight:'24px', color:'#000'}}>
                            <div id="selection">
                                <ul>
                ...
                <div class="col-sm-6 col-md-6 col-lg-6">
                    <center class="wow fadeInUp">
                        <h3 style={{fontFamily:"'Source Sans Pro', sans-serif", backgroundColor:'#3a56a1', color:'#fff', padding:'10px 20px', borderRadius:'5px',border:'2px solid #000' }}>Additional Services</h3>
                    </center>
                        <p style={{textAlign:'justify', fontSize:'16px', lineHeight:'24px', color:'#000'}}>
                            <div id="selection">
                                <ul>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        <center class="wow fadeInUp">
                            <h3 style={{fontFamily:"'Source Sans Pro',sans-serif",color:'#fff', }}>Make critical business decisions backed by powerful insights with One Way Solution. </h3>
                            <Link to="/contactus">
